...
public class PosixSong implements Song
{
    ...
    public PosixSong(String root, String band, String album, String songFile) {
        m_band = band;
        m_album = album;
        m_songFile = songFile;
    }
    ...
    public String uri() {
	String uri = m_root + "/" + m_band;
	if (m_album != null && !(m_album == "")) {
	    uri += "/" + m_album;
	}
	uri += "/" + m_songFile;
	return uri;
    ...
    public boolean equals(Object o) {
        boolean iseq = false;
        if (o instanceof PosixSong) {
            PosixSong other = (PosixSong)o;
            iseq = 
